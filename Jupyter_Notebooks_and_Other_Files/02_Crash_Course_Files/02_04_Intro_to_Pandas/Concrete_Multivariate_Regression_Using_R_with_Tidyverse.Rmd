...
This is an [R Markdown](https://rmarkdown.rstudio.com) Notebook. When you execute code within the notebook, the results appear beneath the code.
...
When you're in [MATH 381 (Intro to Probability and Stats)](https://ecatalog.sdsmt.edu/preview_course_nopop.php?catoid=17&coid=26571) you'll get a taste of R. R is an open-source statistical package build off of an earlier generation of commercial.
...
Also in this exercise, we're going to use the [tidyverse](https://www.tidyverse.org) set of packages. Tidyverse is a set of co-developed tools for data science in R. This is the new big thing in R and is widely used so we are just going to jump in here. SD Mines has a course beyond Engineering Stats, [MATH 443/543 (Data Analysis)](https://ecatalog.sdsmt.edu/preview_course_nopop.php?catoid=17&coid=26973) that leverages this set of packages.
...
-   [Yeh, I-Cheng, "Modeling slump of concrete with fly ash and superplasticizer," *Computers and Concrete*, **5**(6), 559-572, 2008. doi: 10.12989/cac.2008.5.6.559.](https://www.techno-press.org/content/?page=article&journal=cac&volume=5&num=6&ordernum=4)
...
-   [Yeh, I-Cheng, "Prediction of workability of concrete using design of experiments for mixtures," *Computers and Concrete*, **5**(1), 1-20, 2008. doi: 10.12989/cac.2008.5.1.001](https://www.techno-press.org/content/?page=article&journal=cac&volume=5&num=1&ordernum=1)
...
For the superscripting in the x-axis label, I am using the [expression()](https://vis.supstat.com/2013/04/mathematical-annotation-in-r/) tool in R.
